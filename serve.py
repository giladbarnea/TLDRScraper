...
def scrape_date_range(start_date, end_date):
    ...
    ec_url = os.environ.get('EDGE_CONFIG') or os.environ.get('TLDR_SCRAPER_EDGE_CONFIG') or os.environ.get('EDGE_CONFIG_CONNECTION_STRING') or os.environ.get('TLDR_SCRAPER_EDGE_CONFIG_CONNECTION_STRING')
