...
function main(){
    ...
    codex --model=gpt-5.2-high --ask-for-approval=never exec --config='model_reasoning_effort=high' --skip-git-repo-check --sandbox danger-full-access -- "$(cat "$prompt_file")"
}
