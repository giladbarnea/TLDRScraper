	...
	return (
		<article className="group relative pb-16 border-b border-neutral-100">
			<div className="flex items-start justify-between mb-6">
				<div className="text-xs font-mono uppercase tracking-wider text-neutral-400">{article.source}</div>
				<button
			...
			>
				<div className="pt-8 border-t border-neutral-100">
					{aiState === AIState.LOADING ? (
						...
						<div className="text-xs font-mono text-neutral-400">{summaryText}</div>
					) : (
