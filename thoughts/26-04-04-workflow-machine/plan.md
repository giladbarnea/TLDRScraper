...
- Update `docs/ALL_STATES.md` to add the new workflow machine and revise the ownership map.
...
- [ ] `docs/ALL_STATES.md` reflects the new workflow/domain boundary
...
- Current state map: `docs/ALL_STATES.md`
