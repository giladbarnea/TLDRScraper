...
Zen Overlay Plan:
1. **Plan A (Header):** Replace title with context (favicon/domain/meta). Actions: Chevron Down (Collapse), Checkmark (Mark Done/Removed). Dynamic transparency on scroll.
