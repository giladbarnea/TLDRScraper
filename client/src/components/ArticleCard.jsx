					...
					>
						{tldr.loading ? (
							<span className="flex items-center gap-1.5">
								<i data-lucide="loader-2" className="w-3.5 h-3.5 animate-spin"></i> Generating...
							</span>
						) : tldr.expanded ? (
							<span className="flex items-center gap-1.5">
								<i data-lucide="minimize-2" className="w-3.5 h-3.5"></i> Minimize
							</span>
						) : (
							<span className="flex items-center gap-1.5">
								<i data-lucide="sparkles" className="w-3.5 h-3.5"></i> TLDR
							</span>
						)}
					</button>
