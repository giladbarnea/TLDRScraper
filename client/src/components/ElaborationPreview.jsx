...
function LoadingBody({ selectedText, loadingMessage }) {
  return (
...
function ErrorBody({ message, defaultMessage }) {
  return (
...
function ElaborationPreview({
  ...
  loadingMessage = 'Elaborating…',
  errorDefaultMessage = 'Elaboration failed. Try again.',
}) {
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {status === 'loading' && <LoadingBody selectedText={selectedText} loadingMessage={loadingMessage} />}
                  {status === 'error' && <ErrorBody message={errorMessage} defaultMessage={errorDefaultMessage} />}
                  {status === 'available' && (
