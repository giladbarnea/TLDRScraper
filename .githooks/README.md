---
last_updated: 2026-04-19 07:14, d4c35db
---
# Git Hooks
...
- Syncs external skill directories (e.g. `.agents/skills/prompt-subagent`) from `giladbarnae/llm-templates` via `sync-external-subdir.sh`
